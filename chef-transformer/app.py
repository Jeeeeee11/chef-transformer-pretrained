...
class TextGeneration:
    def __init__(self):
        ...
        self.fonts = {
            "title": ImageFont.truetype("\\wsl.localhost\Ubuntu-22.04\home\danilo\env1\DRS-WSL\chef-transformer-pretrained\chef-transformer\asset\fonts\Poppins-Bold.ttf", 70),
